...
const resources = {
  en: {
    translation: {
      ...
      'XO spel is de enige spel die ik vorige jaar had gemaakt. het is zo simple en met html css en javascript gemaakt.':'XO game is the only game i made last year. its so simple and made with html css and javascript.',
...
function updateContent() {
  ...
  document.querySelector("#portfolio").textContent = i18next.t('Vorig jaar heb ik twee portfolio websites ontwikkeld. De eerste heb ik zelfstandig gemaakt, buiten schoolopdrachten om. Vervolgens kregen we een project toegewezen waarbij we een portfolio website voor een tweedejaarsstudent moesten ontwerpen. Dit project heb ik gerealiseerd met behulp van HTML en CSS.');
  ...
  document.querySelector("#xo").textContent = i18next.t('XO spel is de enige spel die ik vorige jaar had gemaakt. het is zo simple en met html css en javascript gemaakt.');
