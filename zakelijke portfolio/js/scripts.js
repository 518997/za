...
const resources = {
  en: {
    translation: {
      ...
      'Het XO spel is het enige spel dat ik vorige jaar heb gemaakt. Het is zo simpel en met html css en javascript gemaakt. het is zo simple en met html css en javascript gemaakt.':'XO game is the only game i made last year. its so simple and made with html css and javascript.',
